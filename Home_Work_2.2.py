...
print(f'Количество парт для всех учеников: {((class_1 + class_2 + class_3) // 2) + ((class_1 + class_2 + class_3) % 2)}')
...
print(f'В этом количестве секунд {sek // 3600}часов:{(sek - ((sek // 3600) * 3600)) // 60}минут:{sek % 60}секунд')
